...
const routes = [
    ...
    {
        path: 'comparator',
        loadChildren: () => __webpack_require__.e(/*! import() | modules-comparator-comparator-module */ "modules-comparator-comparator-module").then(__webpack_require__.bind(null, /*! ./modules/comparator/comparator.module */ "./src/app/modules/comparator/comparator.module.ts")).then(m => m.ComparatorModule)
    }
];
...
class AppComponent {
    constructor() {
        this.title = 'star-wars-ships-comparator';
    }
}
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["swsc-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\colme\OneDrive\Escritorio\prueba\star-wars-ships-comparator\src\main.ts */"./src/main.ts");
